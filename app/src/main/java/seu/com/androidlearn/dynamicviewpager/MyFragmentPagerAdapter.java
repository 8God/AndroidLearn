package seu.com.androidlearn.dynamicviewpager;
/*
...
public abstract class MyFragmentPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String contentHash = getContentHash(position);
        // Do we already have this fragment?
        String name = makeFragmentName(container.getId(), itemId, contentHash);
        ...
        if (fragment != null) {
            ...
            mCurTransaction.add(container.getId(), fragment,
                    makeFragmentName(container.getId(), itemId, contentHash));
        }
    ...
    private String makeFragmentName(int viewId, long id, String contentHash) {
        return "android:switcher:" + viewId + ":" + id + contentHash;
    }

    /**
     * 自定义fragment中内容是否改变的标志
     * @param position
     * @return
     */
